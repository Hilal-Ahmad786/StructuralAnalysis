          ...
          <div className="w-full max-w-[440px] bg-white dark:bg-card-dark rounded-lg shadow-xl overflow-hidden border border-slate-100 dark:border-slate-700">
            <div className="p-8 text-center">
              ...
              <p className="text-slate-500 dark:text-slate-400 mb-6">
                ...
                <strong className="text-slate-900 dark:text-white">{email}</strong>. Click the link
                to activate your account.
              </p>
              <Link
                href="/login"
                className="inline-flex items-center gap-2 px-6 py-3 bg-structura-primary hover:bg-blue-700 text-white rounded-lg font-medium transition-colors"
              >
          ...
          <div className="px-8 pt-10 pb-8 flex flex-col items-center">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-slate-500 dark:text-slate-400 text-sm font-normal leading-normal">
                Start analyzing structures in minutes.
              </p>
            </div>
            ...
            <form onSubmit={handleSignup} className="w-full flex flex-col gap-5">
              ...
              <p className="text-xs text-slate-400 dark:text-slate-500 text-center mt-2">
                ...
                <Link
                  href="/terms"
                  className="text-slate-500 dark:text-slate-400 hover:text-structura-primary transition-colors"
                >
                  Terms of Service
                </Link>{' '}
                and{' '}
